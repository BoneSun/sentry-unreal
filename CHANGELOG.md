...
- Bump Java SDK (Android) from v8.18.0 to v8.22.0 ([#22](https://github.com/BoneSun/sentry-unreal/pull/22))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.22.0)
