...
- Bump Android Gradle Plugin from v5.8.0 to v6.0.0 ([#67](https://github.com/BoneSun/sentry-unreal/pull/67))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#600)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.0.0)
