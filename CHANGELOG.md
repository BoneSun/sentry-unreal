...
- Bump Android Gradle Plugin from v5.8.0 to v6.18.0 ([#183](https://github.com/BoneSun/sentry-unreal/pull/183))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6180)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.18.0)
