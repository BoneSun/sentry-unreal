...
- Bump Java SDK (Android) from v8.18.0 to v8.34.1 ([#89](https://github.com/BoneSun/sentry-unreal/pull/89))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.34.1)
