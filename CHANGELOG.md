...
- Bump Java SDK (Android) from v8.18.0 to v8.45.0 ([#154](https://github.com/BoneSun/sentry-unreal/pull/154))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.45.0)
