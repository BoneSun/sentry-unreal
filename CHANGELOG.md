...
- Bump Android Gradle Plugin from v5.8.0 to v6.21.0 ([#197](https://github.com/BoneSun/sentry-unreal/pull/197))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6210)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.21.0)
