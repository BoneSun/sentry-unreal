...
- Bump Java SDK (Android) from v8.18.0 to v8.26.0 ([#46](https://github.com/BoneSun/sentry-unreal/pull/46))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.26.0)
