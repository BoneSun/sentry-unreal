...
- Bump Java SDK (Android) from v8.18.0 to v8.42.0 ([#131](https://github.com/BoneSun/sentry-unreal/pull/131))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.42.0)
