...
- Bump Java SDK (Android) from v8.18.0 to v8.56.0 ([#199](https://github.com/BoneSun/sentry-unreal/pull/199))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8560)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.56.0)
