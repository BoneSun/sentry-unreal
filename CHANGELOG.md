...
- Bump Java SDK (Android) from v8.18.0 to v8.28.0 ([#52](https://github.com/BoneSun/sentry-unreal/pull/52))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.28.0)
