...
- Bump Java SDK (Android) from v8.18.0 to v8.57.0 ([#203](https://github.com/BoneSun/sentry-unreal/pull/203))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8570)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.57.0)
