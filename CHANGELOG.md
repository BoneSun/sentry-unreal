...
- Bump Java SDK (Android) from v8.18.0 to v8.52.0 ([#182](https://github.com/BoneSun/sentry-unreal/pull/182))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.52.0)
