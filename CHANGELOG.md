...
- Bump Android Gradle Plugin from v5.8.0 to v6.10.0 ([#141](https://github.com/BoneSun/sentry-unreal/pull/141))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.10.0)
