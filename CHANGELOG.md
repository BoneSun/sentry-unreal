...
- Bump Java SDK (Android) from v8.18.0 to v8.35.0 ([#94](https://github.com/BoneSun/sentry-unreal/pull/94))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.35.0)
