...
- Bump Java SDK (Android) from v8.18.0 to v8.36.0 ([#95](https://github.com/BoneSun/sentry-unreal/pull/95))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.36.0)
