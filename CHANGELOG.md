...
- Bump Android Gradle Plugin from v5.8.0 to v6.20.0 ([#190](https://github.com/BoneSun/sentry-unreal/pull/190))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6200)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.20.0)
