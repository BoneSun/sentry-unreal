...
- Bump Java SDK (Android) from v8.18.0 to v8.30.0 ([#63](https://github.com/BoneSun/sentry-unreal/pull/63))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.30.0)
