...
- Bump Java SDK (Android) from v8.18.0 to v8.38.0 ([#108](https://github.com/BoneSun/sentry-unreal/pull/108))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.38.0)
