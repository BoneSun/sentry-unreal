...
- Bump Android Gradle Plugin from v5.8.0 to v6.12.0 ([#151](https://github.com/BoneSun/sentry-unreal/pull/151))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6120)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.12.0)
