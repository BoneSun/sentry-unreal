...
- Bump Android Gradle Plugin from v5.8.0 to v6.13.0 ([#157](https://github.com/BoneSun/sentry-unreal/pull/157))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6130)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.13.0)
