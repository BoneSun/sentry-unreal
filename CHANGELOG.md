...
- Bump Java SDK (Android) from v8.18.0 to v8.40.0 ([#116](https://github.com/BoneSun/sentry-unreal/pull/116))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.40.0)
