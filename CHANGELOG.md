...
- Bump Android Gradle Plugin from v5.8.0 to v6.4.0 ([#109](https://github.com/BoneSun/sentry-unreal/pull/109))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#640)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.4.0)
