...
- Bump Java SDK (Android) from v8.18.0 to v8.37.1 ([#102](https://github.com/BoneSun/sentry-unreal/pull/102))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8371)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.37.1)
