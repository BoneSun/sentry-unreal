...
- Bump Java SDK (Android) from v8.18.0 to v8.48.0 ([#165](https://github.com/BoneSun/sentry-unreal/pull/165))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.48.0)
