...
- Bump Java SDK (Android) from v8.18.0 to v8.32.0 ([#73](https://github.com/BoneSun/sentry-unreal/pull/73))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.32.0)
