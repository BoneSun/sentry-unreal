...
- Bump Java SDK (Android) from v8.18.0 to v8.27.1 ([#49](https://github.com/BoneSun/sentry-unreal/pull/49))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.27.1)
