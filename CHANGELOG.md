...
- Bump Java SDK (Android) from v8.18.0 to v8.39.1 ([#113](https://github.com/BoneSun/sentry-unreal/pull/113))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.39.1)
