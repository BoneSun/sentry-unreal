...
- Bump Java SDK (Android) from v8.18.0 to v8.50.0 ([#173](https://github.com/BoneSun/sentry-unreal/pull/173))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.50.0)
