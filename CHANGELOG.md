...
- Bump Android Gradle Plugin from v5.8.0 to v6.11.0 ([#144](https://github.com/BoneSun/sentry-unreal/pull/144))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6110)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.11.0)
