...
- Bump Java SDK (Android) from v8.18.0 to v8.23.0 ([#29](https://github.com/BoneSun/sentry-unreal/pull/29))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.23.0)
