...
- Bump Java SDK (Android) from v8.18.0 to v8.46.0 ([#156](https://github.com/BoneSun/sentry-unreal/pull/156))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.46.0)
