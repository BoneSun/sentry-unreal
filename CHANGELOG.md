...
- Bump Java SDK (Android) from v8.18.0 to v8.58.0 ([#208](https://github.com/BoneSun/sentry-unreal/pull/208))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8580)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.58.0)
