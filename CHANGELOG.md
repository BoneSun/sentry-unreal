...
- Bump Java SDK (Android) from v8.18.0 to v8.41.0 ([#124](https://github.com/BoneSun/sentry-unreal/pull/124))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.41.0)
