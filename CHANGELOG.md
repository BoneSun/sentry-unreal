...
- Bump Java SDK (Android) from v8.18.0 to v8.54.0 ([#192](https://github.com/BoneSun/sentry-unreal/pull/192))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.54.0)
