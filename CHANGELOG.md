...
- Bump Java SDK (Android) from v8.18.0 to v8.33.0 ([#77](https://github.com/BoneSun/sentry-unreal/pull/77))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.33.0)
