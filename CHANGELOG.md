...
- Bump Java SDK (Android) from v8.18.0 to v8.29.0 ([#57](https://github.com/BoneSun/sentry-unreal/pull/57))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.29.0)
