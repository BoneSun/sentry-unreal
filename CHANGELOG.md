...
- Bump Java SDK (Android) from v8.18.0 to v8.43.0 ([#136](https://github.com/BoneSun/sentry-unreal/pull/136))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.43.0)
