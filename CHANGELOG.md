...
- Bump Android Gradle Plugin from v5.8.0 to v6.17.0 ([#180](https://github.com/BoneSun/sentry-unreal/pull/180))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6170)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.17.0)
