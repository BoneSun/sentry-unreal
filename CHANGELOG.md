...
- Bump Android Gradle Plugin from v5.8.0 to v6.22.0 ([#201](https://github.com/BoneSun/sentry-unreal/pull/201))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6220)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.22.0)
