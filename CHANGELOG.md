...
- Bump Java SDK (Android) from v8.18.0 to v8.44.0 ([#149](https://github.com/BoneSun/sentry-unreal/pull/149))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8440)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.44.0)
