...
- Bump Java SDK (Android) from v8.18.0 to v8.24.0 ([#36](https://github.com/BoneSun/sentry-unreal/pull/36))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.24.0)
