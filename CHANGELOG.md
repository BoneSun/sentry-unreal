...
- Bump Java SDK (Android) from v8.18.0 to v8.47.0 ([#161](https://github.com/BoneSun/sentry-unreal/pull/161))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.47.0)
