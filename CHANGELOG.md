...
- Bump Java SDK (Android) from v8.18.0 to v8.53.0 ([#186](https://github.com/BoneSun/sentry-unreal/pull/186))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.18.0...8.53.0)
