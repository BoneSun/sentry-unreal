...
- Bump Android Gradle Plugin from v5.8.0 to v6.6.0 ([#121](https://github.com/BoneSun/sentry-unreal/pull/121))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#660)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.6.0)
