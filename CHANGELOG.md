...
- Bump Android Gradle Plugin from v5.8.0 to v6.3.0 ([#101](https://github.com/BoneSun/sentry-unreal/pull/101))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#630)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/5.8.0...6.3.0)
